...
namespace LearningNeuralNetworks.LearningAlgorithms
{
    ...
    public class LearningAlgorithm
    {
        ...
        public virtual InterpretedNet<TData, TLabel> Apply<TData,TLabel>(InterpretedNet<TData, TLabel> net, IEnumerable<Pair<TData, TLabel>> trainingData, double trainingRateEta, int iterations = 1)
        {
            return net;
        }

        public virtual InterpretedNet<TData, TLabel> ApplyToBatches<TData, TLabel>(InterpretedNet<TData, TLabel> net, Pair<TData, TLabel>[] trainingData, int batchSize, double trainingRateStart, int iterations = 1)
        {
        ...
        static Pair<TData,TLabel>[] SelectSample<TData, TLabel>(Pair<TData, TLabel>[] trainingData, int sampleSize)
        {
            ...
            var batch = new Pair<TData, TLabel>[sampleSize];
